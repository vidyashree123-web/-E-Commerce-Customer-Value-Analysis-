...
The project follows an end-to-end analytics workflow—from data extraction and cleaning to visualization and business recommendations—using SQL, Python, and Power BI.
